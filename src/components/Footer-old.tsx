    ...
    <footer className='bg-secondary'>
      <MainWrapper className='grid grid-cols-3 gap-5 py-14 '>
        <div className='grid gap-2.5'>
          <Image src={"/footerLogo.svg"} alt='DrDermex logo' width={207} height={34} />
        ...
        <div className='flex flex-col gap-6'>
          <p className='uppercase text-2xl leading-[18px] text-white font-semibold'>quick link</p>
        ...
        <div className='flex flex-col gap-8'>
          <div>
            <p className='font-semibold text-2xl leading-9 uppercase text-white'>newsletter</p>
            <p className='text-white'>Subscribe our newsletter to get our latest update & news</p>
          </div>
